...
Ниже представлены два видео, обработанных и классифицированных алгоритмом, написанным выше. 

Пример №1.

https://github.com/smonobig/labs/assets/86806629/3b44f8f7-0749-43ac-b8d7-613dfc85336e

На этом видео видно, что при большом количестве объектов, алгоритм испытывает некоторые затруднения. Например, одежда питкоманды оценивается алгоритмом как одежда бобслеистов, так же дым из-под колёс алгоритм считает снегом.

Пример №2.

https://github.com/smonobig/labs/assets/86806629/7165778d-0ab4-45d0-a8db-b803d13ef0b8

На этом видео обстановка попроще, так как кроме болидов и трассы ничего нету. Алгоритм практически всё время классифицирует происходящее верно.
